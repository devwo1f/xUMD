...
export const mapLayerIds = {
  ...
  buildingExtrusion: 'campus-building-extrusion',
  ...
  eventPinMultiCircle: 'campus-event-pin-multi-circle',
  eventPinSingleCircle: 'campus-event-pin-single-circle',
  eventPinSingleGlyph: 'campus-event-pin-single-glyph',
  eventPinMulti: 'campus-event-pin-multi',
  eventPinRegular: 'campus-event-pin-regular',
  eventPinGoing: 'campus-event-pin-going',
  eventPinFeatured: 'campus-event-pin-featured',
  eventPinLive: 'campus-event-pin-live',
  eventPinCountLabel: 'campus-event-pin-count-label',
